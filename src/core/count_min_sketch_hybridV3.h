#ifndef COUNT_MIN_SKETCH_HYBRIDV3_H
#define COUNT_MIN_SKETCH_HYBRIDV3_H
...
void universal_hash_array_init_parallel(UniversalHash* hash_array, uint32_t prime, uint32_t width, uint32_t depth);
